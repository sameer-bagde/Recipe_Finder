          ...
          children: isLoading
            ? _jsx("div", {
                ...
                children: _jsx("div", {
                  ...
                  children: _jsxs("div", {
                    className:
                      "max-w-sm rounded overflow-hidden shadow-lg animate-pulse",
                    children: [
                      _jsx("div", { className: "h-48 bg-gray-300" }),
                      _jsxs("div", {
                        className: "px-6 py-4",
                        children: [
                          _jsx("div", { className: "h-6 bg-gray-300 mb-2" }),
                          _jsx("div", { className: "h-4 bg-gray-300 w-2/3" }),
                        ],
                      }),
                      _jsxs("div", {
                        ...
                        children: [
                          _jsx("div", {
                            className: "h-4 bg-gray-300 w-1/4 mb-2",
                          }),
                          _jsx("div", { className: "h-4 bg-gray-300 w-1/2" }),
                        ],
                      }),
                    ],
                  }),
            ...
            : isError
              ? _jsx("p", { children: t("Unable to Load Recipes") })
              : recipes &&
                recipes.length > 0 &&
                _jsxs(_Fragment, {
                  children: [
                    ...
                    visibleRecipes < recipes.length &&
                      _jsx("div", {
                        ...
                        children: _jsx("button", {
                          ...
                          className:
                            "px-4 py-2 bg-indigo-600 text-white font-semibold rounded-lg shadow-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-opacity-75",
